...
class triton_inference:
    ...
    def run(self, service_name, images, camerInfo=None, label_to_detect={},
        ...
        try:
            ...
            pool = get_vllm_triton_pool() if name == "cangqiong" else (
                self._pool_smoking if name == "yolov11det" else self._pool
            )
